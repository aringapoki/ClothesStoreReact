## Versión propia del proyecto Burger Queen de Laboratoria

# Clothes Store (API Client)
...
Una pequeña marca de ropa, que está creciendo, necesita un
sistema a través del cual puedan tomar pedidos usando una _tablet_, y enviarlos
al taller para que se preparen ordenada y eficientemente.
...
> Somos **Clothes Store**, una cadena de ropa de diseñador.
>
> Nuestra propuesta de servicio por estaciones ha tenido muy buena acogida y, para
> seguir creciendo, necesitamos un sistema que nos ayude a tomar los pedidos de
> nuestrxs clientes.
>
> Tenemos 2 catálogos: uno primavera-verano:
>
> | Ítem                      |Precio $|
> |---------------------------|------|
> | Blusa                     |   25 |
...
> | Camisa                    |   25 |
>
> Y otro otoño-invierno:
>
> | Ítem                      |Precio|
> |---------------------------|------|
> |**Conjuntos**              |   **$**   |
> |Chaqueta + jardinera       |   100|
> |Chaqueta + 2 piezas        |   150|
> |**Impermeables**           |   **$**   |
> |Chaquetas                  |    70|
> |Capas                      |    50|
> |**Abrigo**                 |   **$**   |
...
La interfaz debe mostrar los dos catálogos, cada uno
...
#### [Historia de usuario 1] Vendedor/a debe poder ingresar al sistema, si el admin ya le ha asignado credenciales

Yo como vendedor quiero poder ingresar al sistema de pedidos.
...
#### [Historia de usuario 2] Vendedor/a debe poder tomar pedido de cliente/a

Yo como meserx quiero tomar el pedido de unx cliente para no depender de mi mala
memoria, para saber cuánto cobrar, y enviarlo al taller para evitar errores y
...
#### [Historia de usuario 3] Jefe de tienda debe ver los pedidos

Yo como jefx de tienda quiero ver los pedidos de lxs clientes en orden y
marcar cuáles están listos para saber qué se debe confeccionar y avisar a lxs vendedores
que un pedido está listo para enviar a un clientx.

##### Criterios de aceptación

* Ver los pedidos ordenados según se van haciendo.
* Marcar los pedidos que se han preparado y están listos para enviar.
...
#### [Historia de usuario 4] Vendedora debe ver pedidos listos para enviar

Yo como vendedor quiero ver los pedidos que están preparados para entregarlos
rápidamente a lxs clientxs que las hicieron.

##### Criterios de aceptación

* Ver listado de pedido listos para enviar.
